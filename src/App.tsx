      ...
      <section id="about" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-light mb-16 max-w-3xl">
           I help companies design and ship products that solve real problems, using user research and experimentation to drive growth. My work builds AI-powered features that scale, creates experiences that delight users, streamline workflows, and drive meaningful business outcomes.
          </p>
